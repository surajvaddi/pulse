...
const preferencesPage = readFileSync("app/onboarding/preferences/page.tsx", "utf8");
const integrationsPage = readFileSync("app/onboarding/integrations/page.tsx", "utf8");
...
assert.ok(preferencesPage.includes("requireOnboardingStep"));
assert.ok(integrationsPage.includes("requireOnboardingStep"));
